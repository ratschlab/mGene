function [PAR, jobinfo ,all_done]=masterscript_contents(PAR,check_files,verb)
% [PAR, jobinfo ,all_done] = masterscript_contents(PAR,check_files,verb)
...
if tasks.prepare_labels
  ...
  gen_training_examples4content(PAR) ;
end
