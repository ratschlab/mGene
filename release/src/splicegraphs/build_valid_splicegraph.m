function genes = build_valid_splicegraph(genes)
% function genes = build_valid_splicegraph(genes)
% builds splice graphs for all given genes and returns augmented genes
%
% different from build_splicegraph in that it 
%
% ONLY INCLUDES VALID TRANSCRIPTS 
%
% into the splicegraph (based on gene.transcript_valid flags)
...
%  fprintf(1,'gene index:\t%d\n',gene_idx);
  ...
  for transcript_idx = find(genes(gene_idx).transcript_valid)
