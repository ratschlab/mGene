function [x,obj,INFO,lambda] = mosek_lp (x0, q, A, b, lb, ub, A_lb, A_in, A_ub)
% [x,obj,INFO,lambda] = mosek_lp (x0, q, A, b, lb, ub, A_lb, A_in, A_ub)
%
