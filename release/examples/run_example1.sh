...
../src/parsegff/GFFParser.sh ${GFF3_INPUT} ${RESULTDIR}/elegans.anno/genes.mat ${RESULTDIR}/elegans.gio > ${RESULTDIR}/elegans-GFFParser.log
...
${BINDIR}/signal_train  '-' ${RESULTDIR}/elegans-acc-label.bspf/ acc ${RESULTDIR}/elegans.gio ${RESULTDIR}/elegans-acc.tsp/log  ${RESULTDIR}/elegans-acc.tsp 1 > ${RESULTDIR}/elegans-signal_train-acc.log
...
${BINDIR}/anno2contentlabel ${RESULTDIR}/elegans.anno/log  ${RESULTDIR}/elegans.anno ${RESULTDIR}/elegans.gio ${RESULTDIR}/elegans-cds_exon-label.bcpf/log ${RESULTDIR}/elegans-cds_exon-label.bcpf/ cds_exon all_other default > ${RESULTDIR}/elegans-anno2contentlabel-cds_exon.log
...
${BINDIR}/content_train ${RESULTDIR}/elegans-cds_exon-label.bcpf/log ${RESULTDIR}/elegans-cds_exon-label.bcpf/ cds_exon ${RESULTDIR}/elegans.gio/ ${RESULTDIR}/elegans.anno ${RESULTDIR}/elegans-cds_exon.tcp/log ${RESULTDIR}/elegans-cds_exon.tcp/ 1 > ${RESULTDIR}/elegans-content_train-cds_exon.log
